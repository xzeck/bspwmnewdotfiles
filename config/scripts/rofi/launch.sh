...
if [ "$menu" = "music" ]; then
    rofi -modi 'Music:~/.config/scripts/rofi/rofi-music.sh' -show Music -theme music
elif [ "$menu" = "drun" ]; then
    rofi -show drun -theme clean
elif [ "$menu" = "powermenu" ]; then
    rofi -modi 'Powermenu:~/.config/scripts/rofi/rofi-powermenu.sh' -show Powermenu -theme powermenu
